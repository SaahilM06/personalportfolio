  ...
  useEffect(() => {
    ...
    class Particle {
      ...
      draw(ctx: CanvasRenderingContext2D) {
        ...
        ctx.fillStyle = `rgba(64, 169, 255, ${this.opacity})`;
    ...
    const animate = () => {
      ...
      gradient.addColorStop(0, 'rgba(10, 16, 29, 0.8)');
      gradient.addColorStop(1, 'rgba(10, 16, 29, 0.95)');
  ...
  return (
    <div className="absolute inset-0 overflow-hidden">
      ...
      <div 
        ...
        style={{
          background: 'radial-gradient(circle at center, transparent 20%, rgba(10, 16, 29, 0.8) 100%)',
          pointerEvents: 'none'
        }}
      />
    </div>
